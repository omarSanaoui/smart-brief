    ...
    >
      <div>
        ...
        <p className="text-[#64748B] text-[10px] font-mono tracking-[0.2em] mb-6 uppercase flex items-center gap-1.5">
          <span className="w-1 h-3 bg-sbpurple rounded-full"></span>
        ...
        <div className="grid grid-cols-2 gap-4 border-t border-[#2E3A5C]/50 pt-5 mt-2">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col">
              <span className="text-[#64748B] text-[9px] uppercase font-bold tracking-widest leading-none mb-1">Budget</span>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col">
              <span className="text-[#64748B] text-[9px] uppercase font-bold tracking-widest leading-none mb-1">Deadline</span>
      ...
      {showAdminInfo ? (
        <div className="mt-6 pt-4 flex items-center justify-between text-[10px] text-white/40 border-t border-[#2E3A5C]/30 italic">
           <span className="flex items-center gap-1.5 bg-[#2D3652]/40 px-2.5 py-1 rounded-md border border-[#2E3A5C]/40">
             <Users size={12} className="text-sbteal/70"/> {brief.assignedToIds?.length || 0} Team
           </span>
           <span>UID: {brief.clientId.substring(0, 8)}...</span>
        </div>
      ) : (
        <button 
          className="mt-8 w-full flex items-center justify-center gap-2 bg-[#2D3652] hover:bg-sbpurple text-white py-3 rounded-xl text-sm font-bold transition-all duration-300 border border-[#2E3A5C] group-hover:border-sbpurple/50 group-hover:shadow-md"
        >
